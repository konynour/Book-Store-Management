...
static constexpr auto qt_meta_stringdata_ZN9viewBooksE = QtMocHelpers::stringData(
    "viewBooks",
    "addFun",
    "",
    "purFun",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9viewBooksE[] = {
...
Q_CONSTINIT const QMetaObject viewBooks::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9viewBooksE.offsetsAndSizes,
    qt_meta_data_ZN9viewBooksE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9viewBooksE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<viewBooks, std::true_type>,
        // method 'addFun'
...
void *viewBooks::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9viewBooksE.stringdata0))
